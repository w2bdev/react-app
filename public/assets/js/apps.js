var MUTED_COLOR = "#8A8A8F",
    ...
    handleSettingCookie = function() {
        ...
        }), "false" == Cookies.get("sidebar-inverse") ? ($("#setting_sidebar_inverse").prop("checked", !1), $("#setting_sidebar_inverse").trigger("change")) : ($("#setting_sidebar_inverse").prop("checked", !0), $("#setting_sidebar_inverse").trigger("change")), $("#setting_sidebar_minified").live("change", function() {
        ...
        }), "true" == Cookies.get("sidebar-minified") ? ($("#setting_sidebar_minified").prop("checked", !0), $("#setting_sidebar_minified").trigger("change")) : ($("#setting_sidebar_minified").prop("checked", !1), $("#setting_sidebar_minified").trigger("change")), $("#setting_header_inverse").live("change", function() {
    ...
    App = function() {
        ...
        return {
            init: function() {
                this.initSidebar(), this.initHeader(), this.initComponent(), this.initCookie()
            },
